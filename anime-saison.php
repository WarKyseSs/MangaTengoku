...
<body onload="loadAnime(<?php echo $_GET['idAnime'];?>)">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <a href="./catalogue.php">Database</a>
                        ...
                        <div class="product__page__title">
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-6">
                                    <div class="anime__details__title" id="animeSaisonTitle"></div>
                                </div>
                            </div>
                        </div>
                        <div class="row" id="animeSaison"></div>
                    </div>
                </div>
	...
	<script src="js/animeSaison.js"></script>
